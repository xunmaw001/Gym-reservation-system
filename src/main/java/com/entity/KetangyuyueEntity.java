...
public class KetangyuyueEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KetangyuyueEntity() {

	}

	public KetangyuyueEntity(T t) {
		try {
    ...
    public String toString() {
        return "Ketangyuyue{" +
            ...
            ", ketangId=" + ketangId +
            ", yonghuId=" + yonghuId +
            ", ketangyuyueYesnoTypes=" + ketangyuyueYesnoTypes +
            ", ketangyuyueYesnoText=" + ketangyuyueYesnoText +
