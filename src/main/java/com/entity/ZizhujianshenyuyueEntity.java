...
public class ZizhujianshenyuyueEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZizhujianshenyuyueEntity() {

	}

	public ZizhujianshenyuyueEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zizhujianshenyuyue{" +
            "id=" + id +
            ", zizhujianshenId=" + zizhujianshenId +
            ", yonghuId=" + yonghuId +
